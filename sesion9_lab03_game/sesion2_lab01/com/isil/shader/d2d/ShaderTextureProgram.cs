...
namespace Sesion2_Lab01.com.isil.shader.d2d {
    public struct dtVertexTextureColor
    {
        public float X;
        public float Y;
        public float Z;
        ...
        public dtVertexTextureColor(float x, float y, float z, float r, float g, float b, float a, float u, float v)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        public dtVertexTextureColor(float x, float y, float z, float u, float v)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
    ...
    public class ShaderTextureProgram {
        ...
        public void Update(dtVertexTextureColor[] vertices, ushort[] indices) {
            ...
            mVertexBuffer = D3DBuffer.Create<dtVertexTextureColor>(mDevice, BindFlags.VertexBuffer, vertices);
